        ...
        <>  
            <div className="cardKomunitas">
                ...
                <div className="card-body d-flex flex-row">
                    <div>
                        <img src={imgCowok} id='userProfile'/>
                    </div>
            ...
            <div className="popup" id='popup'>
                ...
                <div className="cardKomunitas">
                    <div className="card-body d-flex flex-row">
                        ...
                        <textarea className="form-control" id="exampleFormControlTextarea1" rows="6" placeholder='Bagikan kondisi lingkungan sekitar Anda'></textarea>
                        <textarea className="form-control" id="exampleFormControlTextarea2" rows="1" placeholder='Kota, Provinsi'></textarea>
