...
const FetchDampak = () => {
  const api_url_dampaksinopsis =
    "https://635391d2ccce2f8c02f907b5.mockapi.io/dampak-sinopsis";
  ...
  const api_url_dampaklengkap =
    "https://635391d2ccce2f8c02f907b5.mockapi.io/dampak-lengkap";
            ...
            <div className=" col  ">
              <div className="row">
                <div className="col-6 dampakfirst2">
                  <h1>
                    Dampak Dari Perubahan Iklim atau Pencemaran Lingkungan
                  </h1>
                </div>
      ...
      <div className="container ">
        <div className="pertanyaanDampak">
          ...
          <p>
            ...
            aspek pada perubahan alam dan kehidupan manusia, seperti kualitas
            dan hutan, udara, perairan, dan kesehatan.
          </p>
        </div>
        <div className="row dampaksinopsisflex" id="txt-item">
          {dampaksinopsis.slice(4, 8).map((item, index) => (
            <div
              key={index}
              className="col-md-3 text-center category-item sinopsiscabang"
            >
              ...
              <section class="detail-category">
                <div class="container">
                  <div class="detailjudul">
                    <h1>
                      Yuk Kenali Lebih Lanjut Mengenai Dampak Dari Pencemaran
                      Lingkungan
                    </h1>
                  </div>
