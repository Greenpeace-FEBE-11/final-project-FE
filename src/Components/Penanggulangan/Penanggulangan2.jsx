...
const Penanggulangan = () => {
                    ...
                    <div className="flip-box">
                        ...
                        <div className="flip-box-front text-center responKotak geserBang" style={{backgroundColor: "#018071"}}>
                            <div className="inner colo-white">
                                ...
                                <img className='ReduceImg' src={reduceImg} id="img-3R imgReduce"/>
                            </div>
                        </div>
    ...
    <div className="container-fluid">
        <div className="row">
            ...
            <div className="col">
                <center>
                <img src={pencemaranAirImg} id="gambar-pencemaran" style={{marginTop:"2rem", width: "50vw", marginLeft: "1.5rem", borderRadius: "20px"}}/>
                </center>
            </div>
        </div>
    </div>
